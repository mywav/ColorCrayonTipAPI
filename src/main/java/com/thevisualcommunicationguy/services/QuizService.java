...
public class QuizService {
	...
	public Quiz createQuiz(Long id, String username, String nameofpaper, Date date_taken, Integer question01,
			Integer question02, Integer question03, Integer question04, Integer question05, Integer question06,
			Integer question07, Integer question08, Integer question09, Integer question10) {
		Quiz quiz = new Quiz();
		quiz.setId(id);
